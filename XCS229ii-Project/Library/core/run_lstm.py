...
ROLLING_X = 3
TRAIN_MODEL = True
SAVE_MODEL_FILE_PATH = "./saved_models/lstm-21052021-e20-h7-p1.h5"
...
if __name__ == '__main__':
    ...
    plot_time_series_charts(model_name="lstm", figsize=(20, 8), xlabels=['Date', 'Date'],
    ...
    plot_time_series_charts(model_name="lstm", figsize=(20, 8), xlabels=['Date'], ylabels=['pred_accuracy'],
    ...
    plot_trade_action(model_name="lstm", figsize=(20, 8),
                      fig_name=fig_name_4,
                      xlabels=['Date', 'Date'],
                      ylabels=['real_price', 'pred_price'],
                      data=df_results,
